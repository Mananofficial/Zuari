          ...
          >
            <div className="relative">
              ...
              <div className="overflow-hidden rounded-4xl bg-(--card) shadow-soft">
                <img src={row.img} alt={row.title} loading="lazy" width={1000} height={1200} className="h-full w-full object-cover transition-transform duration-700 hover:scale-105" />
              </div>
            </div>
            <div>
              ...
              <h3 className="mt-4 font-display text-4xl leading-tight md:text-5xl">{row.title}</h3>
              <p className="mt-4 text-lg text-(--muted-foreground)">{row.body}</p>
